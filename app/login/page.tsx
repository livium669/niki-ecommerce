      ...
      <main className="flex-grow flex items-center justify-center px-6 pt-32 pb-20">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-zinc-400">Welcome back to Niki.</p>
          </div>

          <div className="space-y-4">
            <button
              onClick={() => handleSocialSignIn("google")}
              className="w-full flex items-center justify-center gap-3 bg-zinc-900 hover:bg-zinc-800 text-white py-3 px-4 rounded-lg transition-colors font-medium border border-zinc-800"
            >
